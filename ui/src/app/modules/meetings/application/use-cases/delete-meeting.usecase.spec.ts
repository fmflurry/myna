...
describe('DeleteMeetingUseCase', () => {
  ...
  it('removes the meeting matching the given id', async () => {
    ...
    repository.seed([{ id, title: 'Planning', createdAt: new Date(), durationSec: 30, summaries: [], archived: false, hasAudio: false, hasSystemTrack: false, droppedAudioChunks: 0 }]);
  ...
  it('leaves other meetings untouched', async () => {
    ...
    repository.seed([
      { id: keep, title: 'Keep me', createdAt: new Date(), durationSec: 10, summaries: [], archived: false, hasAudio: false, hasSystemTrack: false, droppedAudioChunks: 0 },
      { id: remove, title: 'Remove me', createdAt: new Date(), durationSec: 10, summaries: [], archived: false, hasAudio: false, hasSystemTrack: false, droppedAudioChunks: 0 },
    ]);
