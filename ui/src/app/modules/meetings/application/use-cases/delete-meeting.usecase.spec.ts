...
describe('DeleteMeetingUseCase', () => {
  ...
  it('leaves other meetings untouched', async () => {
    ...
    repository.seed([
      { id: keep, title: 'Keep me', createdAt: new Date(), durationSec: 10, summaries: [], archived: false, hasAudio: false },
      { id: remove, title: 'Remove me', createdAt: new Date(), durationSec: 10, summaries: [], archived: false, hasAudio: false },
    ]);
